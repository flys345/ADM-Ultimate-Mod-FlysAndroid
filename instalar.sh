...
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2ZseXMzNDUvQURNLVVsdGltYXRlLU1vZC1GbHlzQW5kcm9pZC9tYXN0ZXIvUmVxdWVzdA=="
SUB_DOM='base64 -d'
...
AZUL='\e[34m' && MAGENTA='\e[35m' && MAG='\033[1;36m' &&NEGRITO='\e[1m' && SEMCOR='\e[0m'
 case $1 in
  -ne)cor="${AZUL}${NEGRITO}" && echo -ne "${cor}${2}${SEMCOR}";;
  -ama)cor="${AZUL}${NEGRITO}" && echo -e "${cor}${2}${SEMCOR}";;
  -verm)cor="${AZUL}${NEGRITO}[!] ${VERMELHO}" && echo -e "${cor}${2}${SEMCOR}";;
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/flys345/ADM-Ultimate-Mod-FlysAndroid/master/Install/trans &> /dev/null
clear
msg -bar2
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   ...
   wget -O /root/versao https://raw.githubusercontent.com/flys345/ADM-Ultimate-Mod-FlysAndroid/master/versao &> /dev/null
   inst_components
